...
if(isset($_REQUEST['update'])){
    ...
    $Franky = $Haki->query("UPDATE upcoming_services SET name ='$pname', charges='$pcharge', session ='$papply' WHERE id = $Found ");
   ...
   $Akainu = $Haki->query("SELECT * FROM upcoming_services WHERE id ='$Found' ");
   //print_r($Akainu;
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                     ...
                     <b>Service Category: </b> <br>
                        ...
                        <b>Charge: </b> <br>
                        <div class="form-floating form-floating-outline mb-4">
                          <input type="text" class="form-control" name="pcharge" value="<?php echo $Brook->charges ?>" id="basic-default-company" placeholder="% or Taka" />
                        ...
                        <b>Applied Time: </b> <br>
                        <div class="form-floating form-floating-outline mb-4">
                          <input type="text" class="form-control" name="papply" value="<?php echo $Brook->session ?>" id="basic-default-company" placeholder="Session or Time" />
