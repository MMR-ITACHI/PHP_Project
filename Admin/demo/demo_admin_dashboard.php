          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row gy-4">
                ...
                <?php include_once("partials/congratulation&transaction.php") ?>
                ...
                <!-- Four Cards -->
                <!-- weekly&earning&four -->
                <?php include_once("partials/weekly&earning&four.php") ?>
                <!--/ Total Earning -->

                <!-- Sales by Countries -->
                
                <?php include_once("partials/salesbycountry.php") ?>
                <!--/ Sales by Countries -->

                <!-- Deposit / Withdraw -->
                <?php include_once("partials/deposit_withdraw.php") ?>
                <!-- Deposit / Withdraw -->
