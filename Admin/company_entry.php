...
//  print_r($NikoRobin);
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO company(id ,name,address,catagory) VALUES(NULL,'$pname','$pcharge','$papply')";
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Company Entry Page</h5>
                    ...
                    <div class="card-body">
                     ...
                     <b>Company Name: </b> <br>
                        <div class="form-floating form-floating-outline mb-4">
                          ...
                          <input type="text" class="form-control" name="pname"  id="basic-default-fullname" placeholder="Company Name" />
                        ...
                        <b>Address: </b> <br>
                        <div class="form-floating form-floating-outline mb-4">
                          <input type="text" class="form-control" name="pcharge"  id="basic-default-company" placeholder="Company Address" />
                        ...
                        <b>Catagory: </b> <br>
                        <div class="form-floating form-floating-outline mb-4">
                          <input type="text" class="form-control" name="papply"  id="basic-default-company" placeholder="Company Catagory" />
