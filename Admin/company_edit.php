...
if(isset($_REQUEST['update'])){
    ...
    $Franky = $Haki->query("UPDATE company SET name ='$pname', address='$pcharge', catagory ='$papply' WHERE id = $Found ");
   ...
   $Akainu = $Haki->query("SELECT * FROM company WHERE id ='$Found' ");
   //print_r($Akainu;
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                     ...
                     <b>Full Name: </b> <br>
                        ...
                        <b>Address: </b> <br>
                        <div class="form-floating form-floating-outline mb-4">
                          <input type="text" class="form-control" name="pcharge" value="<?php echo $Brook->address ?>" id="basic-default-company" placeholder="% or Taka" />
                        ...
                        <b>Category: </b> <br>
                        <div class="form-floating form-floating-outline mb-4">
                          <input type="text" class="form-control" name="papply" value="<?php echo $Brook->catagory ?>" id="basic-default-company" placeholder="Session or Time" />
