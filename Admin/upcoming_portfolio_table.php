...
$t = $Haki->query("SELECT * FROM  upcoming_portfolio");
                      ...
                      <table class="table">
                        ...
                        <?php while($h = $t->fetch_assoc()){?>
                          ...
                          <tr>
                            ...
                            <td> <a onclick ="return confirm('Are you sure to delete')" href="upcoming_portfolio_delete.php?nid=<?php echo $h['id'] ?>"><div class="button-items"><button type="button" class="btn btn-danger waves-effect waves-light">Delete</a>
                                 

                                 <a href="upcoming_portfolio_edit.php?nid=<?php echo $h['id'] ?>"><button type="button" class="btn btn-dark waves-effect waves-light">Edit</a></i></a> </div></td>
