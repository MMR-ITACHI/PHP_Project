                    ...
                    <div class="card-body">
                     ...
                     <b>Name: </b> <br>
                        <div class="form-floating form-floating-outline mb-4">
                          ...
                          <input type="text" class="form-control" name="pname"  id="basic-default-fullname" placeholder="Service Category" />
                        ...
                        <b>Email: </b> <br>
                        <div class="form-floating form-floating-outline mb-4">
                          <input type="text" class="form-control" name="pemail"  id="basic-default-company" placeholder="% or Taka" />
                        ...
                        <div class="form-floating form-floating-outline mb-4">
                          <input type="text" class="form-control" name="pstall"  id="basic-default-company" placeholder="Session or Time" />
                        ...
                        <b>Loan Amount: </b> <br>
                        <div class="form-floating form-floating-outline mb-4">
                          <input type="text" class="form-control" name="ploan"  id="basic-default-company" placeholder="Session or Time" />
                        ...
                        <b>Interest: </b> <br>
                        <div class="form-floating form-floating-outline mb-4">
                          <input type="text" class="form-control" name="pinterest"  id="basic-default-company" placeholder="Session or Time" />
                        ...
                        <b>Total Loan: </b> <br>
                        <div class="form-floating form-floating-outline mb-4">
                          <input type="text" class="form-control" name="ptotal"  id="basic-default-company" placeholder="Session or Time" />
                        ...
                        <div class="form-floating form-floating-outline mb-4">
                          <input type="text" class="form-control" name="pper"  id="basic-default-company" placeholder="Session or Time" />
